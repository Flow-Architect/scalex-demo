...
const DEFAULT_RAIL_DELAY_MS = 3300;
const INTAKE_RAIL_HOLD_MS = 3300;
const COST_BASIS_RAIL_HOLD_MS = 3300;
const HERMES_RAIL_HOLD_MS = 3600;
const STRIPE_RAIL_HOLD_MS = 5000;
const POLICY_RAIL_HOLD_MS = 5000;
const APPROVED_SPEND_RAIL_HOLD_MS = 3600;
const BLOCKED_RAIL_HOLD_MS = 7200;
const EVIDENCE_RAIL_HOLD_MS = 4200;
const PROFIT_RAIL_HOLD_MS = 5000;
const DETAIL_TRANSITION_MS = 750;
const BLOCKED_COUNT_DURATION_MS = 3000;
const BLOCKED_FLASH_DURATION_MS = 1800;

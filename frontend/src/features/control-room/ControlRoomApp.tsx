...
const DEFAULT_RAIL_DELAY_MS = 2600;
const INTAKE_RAIL_HOLD_MS = 2600;
const COST_BASIS_RAIL_HOLD_MS = 2600;
const HERMES_RAIL_HOLD_MS = 2800;
const STRIPE_RAIL_HOLD_MS = 3800;
const POLICY_RAIL_HOLD_MS = 3800;
const APPROVED_SPEND_RAIL_HOLD_MS = 2800;
const BLOCKED_RAIL_HOLD_MS = 5600;
const EVIDENCE_RAIL_HOLD_MS = 3200;
const PROFIT_RAIL_HOLD_MS = 3800;
const DETAIL_TRANSITION_MS = 650;
const BLOCKED_COUNT_DURATION_MS = 2200;
const BLOCKED_FLASH_DURATION_MS = 1400;

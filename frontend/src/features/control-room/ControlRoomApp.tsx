...
const DEFAULT_RAIL_DELAY_MS = 3000;
const INTAKE_RAIL_HOLD_MS = 3000;
const COST_BASIS_RAIL_HOLD_MS = 3000;
const HERMES_RAIL_HOLD_MS = 3300;
const STRIPE_RAIL_HOLD_MS = 4500;
const POLICY_RAIL_HOLD_MS = 4500;
const APPROVED_SPEND_RAIL_HOLD_MS = 3300;
const BLOCKED_RAIL_HOLD_MS = 6500;
const EVIDENCE_RAIL_HOLD_MS = 3800;
const PROFIT_RAIL_HOLD_MS = 4500;
